...
function LoadingOverlay({
  ...
  return (
    <div
      className={cn(
        "w-full h-full data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/70 backdrop-blur-2xl",
        className
      )}
      {...props}
    >
